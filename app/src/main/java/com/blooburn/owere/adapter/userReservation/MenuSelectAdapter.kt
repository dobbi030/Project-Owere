...
import com.blooburn.owere.activity.userMain.userReservation.CheckboxAddedListener
import com.blooburn.owere.activity.userMain.userReservation.ReserveActivity
import com.blooburn.owere.activity.userMain.userReservation.ReserveMenuActivity
import com.blooburn.owere.activity.userMain.userReservation.checkBoxlist
import com.blooburn.owere.databinding.ItemReservePriceMenuBinding
import com.blooburn.owere.item.StyleMenuItem
import kotlinx.coroutines.selects.select


class MenuSelectAdapter(val checkboxAddedListener: CheckboxAddedListener) : RecyclerView.Adapter<MenuSelectAdapter.ViewHolder>(){
...
//    }
    ...
    inner class ViewHolder(private val binding: ItemReservePriceMenuBinding) :RecyclerView.ViewHolder(
        binding.root
    ){
