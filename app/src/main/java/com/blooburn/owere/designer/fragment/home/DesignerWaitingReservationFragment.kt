...
class DesignerWaitingReservationFragment : Fragment(R.layout.waiting_fragment_layout) {
    ...
    private lateinit var waitingAdapter: DesignerReservationListAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //확정된 예약 리사이클러뷰 초기화
        waitingAdapter = DesignerReservationListAdapter()
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    snapshot.children.forEach { DateSnapshot ->
                            ...
                            DateSnapshot.children.forEach { reservationSnapshot ->
                                var reservation : DesignerReservation? = reservationSnapshot.getValue(DesignerReservation::class.java)
                                ...
                                waitingAdapter.setData(epochDay, waitingReservation)
